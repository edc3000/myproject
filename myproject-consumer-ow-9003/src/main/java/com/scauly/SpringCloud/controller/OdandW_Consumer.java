...
public class OdandW_Consumer {
    ...
    //创建订单
    @RequestMapping(value = "consumer/order/add", method = RequestMethod.GET)
    public int  add(@RequestBody Fundorder fundorder){
        return owClientService.add(fundorder);
    }

    //查找所有订单
    @RequestMapping(value = "consumer/order/selectall", method = RequestMethod.GET)
