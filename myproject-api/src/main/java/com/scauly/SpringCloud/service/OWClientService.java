...
public interface OWClientService {
    ...
    //创建钱包
    @RequestMapping(value = "wallet/add",method = RequestMethod.GET, consumes = MediaType.APPLICATION_JSON_VALUE)
    public int add(@RequestBody Wallet wallet);

    //查找钱包归属
    @RequestMapping(value = "wallet/findwallet/{uid}", method = RequestMethod.GET, consumes = MediaType.APPLICATION_JSON_VALUE)
    public @ResponseBody Wallet findwallet(@PathVariable("uid") Long uid);

    //付款
    @RequestMapping(value = "wallet/pay", method = RequestMethod.GET, consumes = MediaType.APPLICATION_JSON_VALUE)
    public int pay(@RequestBody Wallet wallet);

    //充值未审核
    @RequestMapping(value = "wallet/uprecharge", method = RequestMethod.GET, consumes = MediaType.APPLICATION_JSON_VALUE)
    public int uprecharge(@RequestBody Wallet wallet);

    //充值已审核
    @RequestMapping(value = "wallet/recharge",method = RequestMethod.GET, consumes = MediaType.APPLICATION_JSON_VALUE)
    public int recharge(@RequestBody Wallet wallet);

    //提现未审核
    @RequestMapping(value = "wallet/upwithdraw",method = RequestMethod.GET, consumes = MediaType.APPLICATION_JSON_VALUE)
    public int upwithdraw(@RequestBody Wallet wallet);

    //提现已审核
    @RequestMapping(value = "wallet/withdraw",method = RequestMethod.GET, consumes = MediaType.APPLICATION_JSON_VALUE)
